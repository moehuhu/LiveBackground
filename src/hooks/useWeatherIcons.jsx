...
const useWeatherIcon = (props) => {
    ...
    const getIconList = () => {
        const icons = {
            ...
            'CLOUDY': cloudy(),
            'LIGHT_HAZE': dayNight(haze),
            'MODERATE_HAZE': dayNight(haze, 2),
            'HEAVY_HAZE': dayNight(haze, 3),
            'LIGHT_RAIN': _.take(rain),
            'MODERATE_RAIN': _.take(rain, 2),
            'HEAVY_RAIN': _.takeRight(rain, 2),
            'STORM_RAIN': _.takeRight(rain),
            'FOG': fog,
            'LIGHT_SNOW': [...cloud, ...snow, ...snowflake],
            'MODERATE_SNOW': [...cloud, ...snow],
            'HEAVY_SNOW': [...snow, ...snowflake],
            'STORM_SNOW': [...snow, ...multIcons(snowflake, 2)],
            'DUST': [...cloudy(), ...dust],
            'SAND': [...cloudy(), ...sand],
            'WIND': [...cloudy(), ...windy()],
        }
